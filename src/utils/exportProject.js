...
export async function copyShareText({ characterName, messageCount, ending }) {
  ...
  const text = `我让${characterName}活起来啦！我们已经聊了 ${messageCount} 句话${endingText}。来自绘梦伙伴。`;
