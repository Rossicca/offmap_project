...
export default function CustomSceneObject({ object, action, doorOpen, onInteract, onSelect, selected, onMove, onMoveEnd }) {
  ...
  return (
    <button
      className={`scene-object custom-drawn-object custom-kind-${object.kind} action-${action || "idle"} ${selected ? "is-selected" : ""} ${action ? "is-animating" : ""} ${dragging ? "is-dragging" : ""}`}
